...
var base = Rebase.createClass('https://catch-of-the-day-ksk.firebaseio.com/');
...
var Inventory = React.createClass({
  renderInventory : function(key) {
    ...
    console.log('renderInventory', fishes.fish1.price, key);
    return (
      <div className="fish-edit" key={key}>
        {/*<input type="text"
               value={'fishes.'+ key +'.name'}
